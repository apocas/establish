...
var compress = function(s, setup, cb) {
  ...
  console.log(path.join(os.tmpdir(), setup.name + '.tar.gz'));
  pack(setup.folder)
    .pipe(write(path.join(os.tmpdir(), setup.name + '.tar.gz')))
...
var backup = function(s, setup, cb) {
